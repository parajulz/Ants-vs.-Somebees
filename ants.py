...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        [i.reduce_health(amount) for i in self.place.bees[:]]
...
class WallAnt(Ant):
    ...
    def __init__(self):
        super().__init__(self.initial_health)
# END Problem 6
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, gamestate):
        ...
        while tunnel is not None:
            if tunnel.ant is not None:
                tunnel.ant.double()
                if tunnel.ant.is_container:
                    tunnel.ant.is_container = True
                    if tunnel.ant.ant_contained:
                        tunnel.ant.ant_contained.double()
            tunnel = tunnel.exit
